        ...
        <div className="min-h-screen bg-slate-950 pt-24 pb-16">
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    >
                        A seamless, end-to-end workflow designed for community health workers in
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {STEPS.map((step, i) => (
                        ...
                        >
                            <div
                                className={`h-14 w-14 rounded-xl ${step.bg} ${step.color} flex items-center justify-center mb-6 text-2xl group-hover:scale-110 transition-transform`}
                            >
