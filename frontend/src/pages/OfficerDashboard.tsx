...
import { Users, Activity, AlertTriangle, UserCheck } from "lucide-react";
import {
    AreaChart,
    Area,
    XAxis,
...
import { useOfficerDashboardStats } from "../hooks/useOfficerDashboardStats";

export function OfficerDashboard() {
    const { stats, loading, villageStats, riskData } =
        useOfficerDashboardStats();
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p className="text-sm text-slate-400">
                                Screenings and patient registrations
                            </p>
                        </div>
                    </div>
