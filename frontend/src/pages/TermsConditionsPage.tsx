                ...
                >
                    ...
                    <div className="prose prose-invert max-w-none space-y-6 text-slate-300">
                        <section>
                            ...
                            <p>
                                By accessing and using RuralHealthAI ("the Platform"), you accept
                        ...
                        <section>
                            ...
                            <p>
                                RuralHealthAI provides a digital health screening platform designed
                                for community health workers to assess and manage health risks in
                                rural populations. The Platform includes:
                            </p>
                        ...
                        <section>
                            ...
                            <p>
                                To register as a health worker, you must be a qualified healthcare
                                professional or community health worker authorized to provide health
                                screening services.
                            </p>
                            ...
                            <p>
                                Health officer accounts are restricted to authorized supervisory
                                personnel responsible for population health management.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="bg-amber-500/10 border border-amber-500/20 p-4 rounded-lg">
                                ...
                                <ul className="list-disc pl-6 space-y-2">
                                    <li>
                                        The Platform provides risk assessment tools, not medical
                                        diagnosis
                                    </li>
                                    ...
                                    <li>
                                        The Platform does not replace professional medical judgment
                                    </li>
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                by RuralHealthAI and protected by copyright, trademark, and other
                        ...
                        <section>
                            ...
                            <p>
                                Patient health data remains the property of the patient. We act as a
                                data processor on behalf of healthcare providers.
                            </p>
                            <h3 className="text-lg font-semibold text-white mb-2 mt-4">
                                8.2 Aggregate Data
                            </h3>
                            <p>
                                We may use anonymized, aggregate data for research, analytics, and
                        ...
                        <section>
                            ...
                            <p>
                                To the maximum extent permitted by law, RuralHealthAI shall not be
                                liable for:
                            </p>
                            <ul className="list-disc pl-6 space-y-2">
                        ...
                        <section>
                            ...
                            <p>
                                You agree to indemnify and hold harmless RuralHealthAI from any
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                service. We may suspend or terminate services for maintenance,
                                updates, or security reasons.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="bg-slate-800/50 p-6 rounded-2xl mt-4 border border-white/5 space-y-3">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="text-white">legal@ruralhealthai.org</div>
                                </div>
                                <div className="flex items-start gap-4">
