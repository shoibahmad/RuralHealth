...
import { WifiOff, Mic, ScanText, BarChart3, Lock, Globe, Zap, Users } from "lucide-react";
        ...
        <div className="min-h-screen bg-slate-950 pt-24 pb-16">
            <div className="container mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    >
                        Our platform combines offline reliability with state-of-the-art AI to
                        transform how healthcare is delivered in remote regions.
                    </motion.p>
                </div>
