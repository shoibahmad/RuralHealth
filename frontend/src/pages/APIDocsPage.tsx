            ...
            <main className="flex-1 w-full max-w-5xl mx-auto p-6 lg:p-12 space-y-24">
                ...
                <section id="intro" className="scroll-mt-24 space-y-6">
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                        ...
                        <p className="text-xl text-slate-400 leading-relaxed">
                            Welcome to the developer documentation. This REST API allows you to
                            integrate health screening, patient management, and AI analysis features
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="p-4 rounded-lg bg-slate-900 border border-white/5 flex items-center gap-3">
                            ...
                            <code className="text-emerald-400 font-mono bg-emerald-950/30 px-2 py-1 rounded">
                                https://api.ruralhealth.ai/api
                            </code>
                        </div>
                        <div className="p-4 rounded-lg bg-slate-900 border border-white/5 flex items-center gap-3">
                ...
                <section id="auth" className="scroll-mt-24 space-y-8">
                    ...
                    <div className="prose prose-invert max-w-none text-slate-400">
                        <p>
                            The API uses{" "}
                            <span className="text-white font-medium">JWT (JSON Web Tokens)</span>{" "}
                            for authentication. You must include the token in the Authorization
                            ...
                            <div className="grid lg:grid-cols-2 gap-6">
                                <div className="space-y-4 text-sm text-slate-400">
                                    ...
                                    <ul className="space-y-2">
                                        <Param name="full_name" type="string" required>
                                            Full legal name
                                        </Param>
                                        <Param name="age" type="integer" required>
                                            Age in years
                                        </Param>
                                        <Param name="gender" type="string" required>
                                            Male, Female, or Other
                                        </Param>
                                        <Param name="village" type="string" required>
                                            Village name
                                        </Param>
                                    </ul>
                                </div>
  ...
  "phone": "+919876543210"
                ...
                <section id="screening" className="scroll-mt-24 space-y-8">
                    ...
                    <p className="text-slate-400">
                        When you submit a screening, the system automatically triggers the{" "}
                        <span className="text-purple-400 font-medium">Gemini AI Engine</span> to
                        analyze the vitals and generate a risk assessment.
                    </p>
                ...
                <section id="errors" className="scroll-mt-24 space-y-8 pb-32">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                            ...
                            <div
                                key={err.code}
                                className="p-4 rounded-lg bg-slate-900/50 border border-white/5 flex justify-between items-center"
                            >
    ...
    return (
        <div className="space-y-2">
            ...
            <div className="flex items-center gap-3 font-mono text-sm">
                <span className={cn("px-2.5 py-0.5 rounded border font-bold", color)}>
                    {method}
                </span>
...
function CodeBlock({ language, code, title }: { language: string; code: string; title?: string }) {
    return (
        <div className="rounded-xl overflow-hidden border border-white/10 bg-[#0d1117]">
            {title && (
                <div className="px-4 py-2 border-b border-white/5 text-xs text-slate-500 font-medium uppercase tracking-wider bg-white/5">
                    {title}
                </div>
            )}
...
function Param({
    ...
    return (
        <li className="flex gap-2 text-sm">
            ...
            {required && (
                <span className="text-amber-500 text-xs mt-0.5 font-medium">required</span>
            )}
