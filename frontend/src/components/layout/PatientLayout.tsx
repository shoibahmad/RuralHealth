                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button
                                ...
                                className="h-10 w-10 rounded-full bg-gradient-to-br from-pink-400 to-rose-600 p-[2px] shadow-lg shadow-pink-500/30 hover:scale-105 transition-transform"
                            >
                                <div className="h-full w-full rounded-full bg-slate-900 flex items-center justify-center">
                                    <span className="font-bold text-white text-sm">
                                        {user?.full_name ? user.full_name.charAt(0).toUpperCase() : user?.email?.charAt(0).toUpperCase() || "P"}
                                    </span>
                                </div>
                            </button>
                        </div>
                        ...
                        >
                            ...
                            <div className="flex-1 overflow-y-auto p-6 space-y-6">
                                ...
                                <div className="flex flex-col items-center text-center">
                                    <div className="h-20 w-20 rounded-full bg-gradient-to-br from-pink-400 to-rose-600 p-[3px] shadow-lg shadow-pink-500/30 mb-4">
                                        <div className="h-full w-full rounded-full bg-slate-900 flex items-center justify-center">
                                    ...
                                    <p className="text-sm text-pink-400 font-medium uppercase tracking-wide">
