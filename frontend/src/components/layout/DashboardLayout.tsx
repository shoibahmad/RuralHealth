                    ...
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center gap-8">
                            <Link to="/dashboard" className="flex items-center gap-2">
                                <div className="bg-gradient-to-tr from-teal-400 to-blue-500 p-1.5 rounded-lg shadow-lg shadow-teal-500/20">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button
                                ...
                                className="h-10 w-10 rounded-full bg-gradient-to-br from-teal-400 to-blue-600 p-[2px] shadow-lg shadow-teal-500/30 hover:scale-105 transition-transform"
                            >
