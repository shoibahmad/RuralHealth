                    ...
                    return (
                        <div key={index} className="flex flex-col items-center px-2 relative">
                                ...
                                <div
                                    className={cn(
                                        ...
                                        isCompleted
                                            ...
                                            : isCurrent
                                              ? "bg-slate-900 border-teal-500 text-teal-400 shadow-md shadow-teal-500/10"
                            ...
                            <div className="absolute top-14 left-1/2 -translate-x-1/2 w-32 text-center mt-2">
                                <p
                                    className={cn(
                                        "text-xs md:text-sm font-semibold transition-colors duration-300 hidden md:block",
                                        isCurrent ? "block text-white" : "text-slate-500",
                                    )}
                                >
                                    {step.label}
                                </p>
                                <p className="text-[10px] uppercase tracking-wider font-medium text-slate-500 hidden lg:block mt-1">
                                    {step.description}
                                </p>
                            </div>
                        </div>
