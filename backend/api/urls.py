...
urlpatterns = [
    ...
    path(
        'screening/patients/<int:pk>/history', PatientHistoryView.as_view(), name='patient_history'
    ),
    # Screening endpoints
    ...
    path(
        'recommendations/<int:pk>', RecommendationDetailView.as_view(), name='recommendation_detail'
    ),
    ...
    path(
        'patient/history', PatientScreeningHistoryView.as_view(), name='patient_screening_history'
    ),
